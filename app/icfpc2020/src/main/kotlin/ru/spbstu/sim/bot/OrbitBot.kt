    ...
    init {
        step { ship, gameState, mapState ->
            ...
            when {
                ...
                !isCompensateY && abs(velocity.x) == 0L && gravity.x != 0L -> acceleration += Coordinates(gravity.x, 0)
            ...
            when {
                ...
                !isCompensateX && abs(velocity.y) == 0L && gravity.y != 0L -> acceleration += Coordinates(0, gravity.y)
