    ...
    init {
        step { ship, gameState, mapState ->
            ...
            when {
                ...
                !isAlongPlanet && abs(velocity.x) == 0L && gravity.x != 0L -> acceleration += Coordinates(gravity.x, 0)
            ...
            when {
                ...
                !isAlongPlanet && abs(velocity.y) == 0L && gravity.y != 0L -> acceleration += Coordinates(0, gravity.y)
